	...
	public SolarSystemScreen(Game aGame) {
		...
		*/
		...
		solarSystem.addProbe(
			...
			//new Vector3d(0, -6384400, 0), // Position realtive to earth
			//new Vector3d(38000, -100000, -1000) // Initial velocity relative to earth
			new Vector3d(0, -6384400, 0), // Position realtive to earth
			new Vector3d(38000, -100_000, 0) // Initial velocity relative to earth
		);
